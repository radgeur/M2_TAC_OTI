...
QUnit.test("value can't be negativ", function(assert)
{
	assert.throws(function(assert) {var mNegativ=new money(-2,"UNK")}, ValueNegativExc, "value is negativ");
});

QUnit.test("currency length need to be 3", function(assert)
{
	assert.throws(function(assert) {var mNegativ=new money(2,"UNKOWN")}, CurrencyLengthExc, "Currency length is different than 3");
});
