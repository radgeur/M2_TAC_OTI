...
L'erreur présente de base dans le fichier celc.js a été résolu.
...
/!\ il n'y a pas de test pour la soustraction
Créez également des nouveaux tests (selon le modèle calc_test.js) pour couvrir cette nouvelle opération (SUB)
